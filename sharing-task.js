...
return (`Name: ${name}, Role: ${role}`);
 ...
 console.log(generateBadge("Cody", "gamer"));
...
console.log(calculateEventCost(150, 50));
...
console.log(isValidEmail("Student@email.com"));
console.log(isValidEmail("Student@email"));
console.log(isValidEmail("Student"));
console.log(isValidEmail("Studentemail.com"));
